...
export default class News extends Component {
  ...
  constructor() {
    super();
    console.log("Hello I'm a constructor from the news class.")
    this.state = {
      ...
      <div className='container my-3'>
        ...
        <div className="row">
          ...
          return <div className="col-md-4 my-2">
            <NewsItems title={element.title.slice(0, 72)} description={element.description.slice(0, 148)} imageUrl={element.urlToImage} newsUrl={element.url} />
          </div>
          })}
        </div>
      </div>
