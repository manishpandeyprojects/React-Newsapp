...
export default class News extends Component {
  ...
  async fetchData(page){
    ...
    this.setState({article: parseData.articles, totalPage: Math.ceil(parseData.totalResults/this.pageSize)});
  }
    ...
    return (
      <>
        ...
        <div className='container d-flex justify-content-between my-3'>
          ...
          <button type="button" disabled={this.state.page>=this.state.totalPage} onClick={this.handleNextClick} className="btn btn-dark">Next</button>
        </div>
      </>
    )
  }
